...
The code for this project is handled via its [GitHub Repository](https://github.com/justintadlock/hybrid-template-hierarchy).  You can open tickets, create patches, and send pull requests there.
